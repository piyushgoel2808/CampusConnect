 ...
 * @author piyush
 */
public class AlumniPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SEARCH ALUMINI:");
  ...
  String searchText = txtSearch.getText().trim();
    ...
    try (Connection conn = dbconnection.getConnection()) {
        ...
        ps.setString(1, "%" + searchText + "%");  // partial match
        ...
        if (model.getRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "No matching alumni found.");
        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        // Fetch data through popup input dialogs
...
String batch = JOptionPane.showInputDialog(this, "Enter Batch:");
if (batch == null || batch.trim().isEmpty()) {
    JOptionPane.showMessageDialog(this, "Batch is required.");
    return;
}
...
try (Connection conn = dbconnection.getConnection()) {
    ...
    String sql = "INSERT INTO alumni (name, batch, email, username, password) VALUES (?, ?, ?, ?, ?)";
    PreparedStatement ps = conn.prepareStatement(sql);

    ps.setString(1, name.trim());
    ps.setString(2, batch.trim());
    ...
    if (rowsInserted > 0) {
        ...
        loadAlumniData(); // refresh table
    }

} catch (Exception e) {
    JOptionPane.showMessageDialog(this, "Error adding alumni: " + e.getMessage());
}
    ...
    int alumniId = (int) jTable1.getValueAt(selectedRow, 0);
    String currentName = (String) jTable1.getValueAt(selectedRow, 1);
    String currentBatch = (String) jTable1.getValueAt(selectedRow, 2);
    String currentEmail = (String) jTable1.getValueAt(selectedRow, 3);

    // Ask for new values
    String newName = JOptionPane.showInputDialog(this, "Edit Name:", currentName);
    if (newName == null) return;

    String newBatch = JOptionPane.showInputDialog(this, "Edit Batch:", currentBatch);
    ...
    try (Connection conn = dbconnection.getConnection()) {
        ...
        String sql = "UPDATE alumni SET name = ?, batch = ?, email = ? WHERE Alumni_id = ?";
        PreparedStatement ps = conn.prepareStatement(sql);

        ps.setString(1, newName.trim());
        ps.setString(2, newBatch.trim());
        ps.setString(3, newEmail.trim());
        ps.setInt(4, alumniId);
  ...
  loadAlumniData();   // Reloads all data from database into JTable
    JOptionPane.showMessageDialog(this, "Table refreshed successfully!");
        // TODO add your handling code here:
    }//GEN-LAST:event_btnRefreshActionPerformed
public void loadAlumniData() {
    try (Connection conn = dbconnection.getConnection()) {
